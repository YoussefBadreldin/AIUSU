        ...
        <div class="container">
            ...
            <div v-if="committeeInfo" class="mt-4">
                ...
                <div class="election-guidelines mt-4">
                    ...
                    <ul>
                        <li>(2 في كل لجنة) ستقوم بانتخاب 14 عضوًا لسبع لجان.</li>
                    </ul>
                    <h5> :خطوات التصويت</h5>
                    <ol>
                        <li>قم بالتوقيع في كشف الحضور قبل أن تبدأ بالتصويت.</li>
                        <li>ستتلقى ورقة انتخابية مخصصة لك.</li>
                        <li>اكتب أسماء 14 مرشحًا، بحيث يكون لكل اثنين في لجنة معينة.</li>
                        <li>تأكد من كتابة 14 اسمًا، لأن أي ورقة تحتوي على أقل من 14 اسمًا أو علامات غير صحيحة ستعتبر باطلة.</li>
                    </ol>
                    <h5>ملاحظات مهمة:</h5>
                    <ul>
                        <li>يمكنك انتخاب المرشحين المذكورين اعلاه فقط، ولا يمكنك انتخاب طلاب اخري</li>
                    </ul>
                </div>
            </div>
        </div>
